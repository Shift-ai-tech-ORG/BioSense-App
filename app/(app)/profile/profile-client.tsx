      ...
      <div>
        ...
        <p className="text-[13px] text-t2">
          ...
          <span
            ...
            style={{
              background: user.subscriptionStatus === 'ACTIVE' ? 'rgba(77,200,140,0.1)' : '#192018',
              color: user.subscriptionStatus === 'ACTIVE' ? '#4dc88c' : '#4f6b57',
              border: user.subscriptionStatus === 'ACTIVE' ? '1px solid rgba(77,200,140,0.2)' : '1px solid rgba(255,255,255,0.055)',
            }}
          >
